...
enum {
	...
	kCellCopyright,
	kCellSpace,
	kCellLeftSquareBracket,
	kCellRightSquareBracket,
...
LOCALVAR const char Cell2MacAsciiMap[] = {
	...
	'\251', /* kCellCopyright */
	'\040', /* kCellSpace */
	'\133', /* kCellLeftSquareBracket */
	'\135', /* kCellRightSquareBracket */
...
LOCALVAR const ui3b Cell2WinAsciiMap[] = {
	...
	0xA9, /* kCellCopyright */
	0x20, /* kCellSpace */
	0x5B, /* kCellLeftSquareBracket */
	0x5D, /* kCellRightSquareBracket */
...
LOCALVAR const ui4b Cell2UnicodeMap[] = {
	...
	0x0020, /* kCellSpace */
	0x005B, /* kCellLeftSquareBracket */
	0x005D, /* kCellRightSquareBracket */
	...
	while (0 != (c = *p++)) {
		if ('^' == c) {
			...
			switch (c) {
				...
				case '[': x = kCellLeftSquareBracket; break;
				case ']': x = kCellRightSquareBracket; break;
